...
<div id="view" >
			...
			<div class="panel panel-primary" >
				<div class="panel-heading" >
					<h3 class="panel-title">
						<i class="glyphicon glyphicon-list"></i>Form Input Data Dokter
					</h3>
				</div>
				<div style="float:left; width: 100%; ">
					<b style="color: orange;"><h4><s:actionmessage /></b>
				</div>
				<form action="simpanDokter.action" namespace="/dokter" method="post"
	...
	<script>
	 ...
	 function onlyNumber(id) {
			...
			<%-- <div class="panel-body" style="background: transparent; background-color: transparent; font-family: monospace; font-size: medium;">
            ...
            <div class="panel-body table-responsive fortable">
             <table id="tbl_dok" class="display" cellspacing="0" width="100%" >
				...
				<tbody>
					...
					<s:url id="delete" namespace="/dokter" action="delete.action">
						<s:param name="dokter.kd_dokter" value="%{#list_dokter.kd_dokter}" />
					</s:url>||
