				...
				<form namespace="dok_jas" method="post"
					...
					<div class="panel-body">
							...
							<div class="row">
								<div class="col-sm-3">
									<s:textfield name="jasa.kd_jasa" id="kd_jasa"
										cssClass="form-control" placeholder="kode jasa"
						...
						<div class="form-group ">
							...
							<div class="row">
								<div class="col-sm-4">
									<s:textfield name="jasa.harga" id="harga"
										cssClass="form-control" placeholder="Rp.0"
						...
						<div class="form-group">
							...
							<div class="right col-sm-1">
								<s:submit action="simpanJasa" cssClass="btn btn-success" value="simpan"></s:submit>
							</div>
						</div>
					</div>
				</form>
