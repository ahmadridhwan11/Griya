...
<div id="view">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary" >
				...
				<form  namespace="/jas" method="post"
					...
					<div class="panel-body">
							...
							<div class="row">
								<div class="col-sm-1">
									<s:textfield name="jasa.persen" id="persen" cssClass="form-control"
										placeholder="0%" onInput="persenp('persen')" maxLength="2"/>
								</div>
							</div>
						</div>
						<div class="form-group ">
						...
						<div class="form-group ">
			                ...
			                <div class="row">
				                ...
				                <s:hidden name="jasa.dokter.nama" id="nama_dokter"></s:hidden>
	...
	function setKdDOkter() {
		 var id = document.getElementById("dokter").value;
	       ...
	       document.getElementById("nama_dokter").value=data[0].trim();
	}
