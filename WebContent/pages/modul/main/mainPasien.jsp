...
<body>
			...
			<ul class="user-menu">
				<li class="dropdown pull-right"><a href="#"
					class="dropdown-toggle" data-toggle="dropdown"><svg
						...
						<use xlink:href="#stroked-male-user"></use></svg> Hello Passien,<%if(session.getAttribute("userName")!=null){User u =(User)session.getAttribute("userName"); out.print(u.getNama());} %>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar"
		...
		<ul class="nav menu"
			...
			<li class="parent">
			<li><s:url id="hs" namespace="/c_pasien"
					action="inputPasienp.action">
				</s:url> <s:a href="%{hs}">
