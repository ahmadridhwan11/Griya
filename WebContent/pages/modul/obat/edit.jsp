			...
			<div class="panel panel-primary" >
				<div class="panel-heading"  >
					<h3 class="panel-title">
						<i class="glyphicon glyphicon-list"></i>Form Edit Data Obat
					</h3>
				</div>
				<form namespace="obat" method="post"
					...
					<div class="panel-body">
							...
							<div class="row">
								<div class="col-sm-3">
									<s:textfield name="obat.kd_obat" id="kd_obat"
										cssClass="form-control" placeholder="kode obat"></s:textfield>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-4">
									<s:textfield name="obat.nama_obat" id="nama_bat"
						...
						<div class="form-group ">
							...
							<div class="row">
								<div class="col-sm-1">
									<s:textfield  id="Keuntungan"
										cssClass="form-control" placeholder="0" maxlength="4" onInput="untung('Keuntungan')"/>
								</div>
							</div>
						</div> 
						<div class="form-group ">
							...
							<div class="row">
								<div class="col-sm-2">
									<s:textfield id="harga"
										cssClass="form-control" placeholder="0" onInput="onlyNumber('harga')" maxlength="8"/>
								</div>
							</div>
						</div>
						<div class="form-group ">
						...
						<%-- <div class="form-group ">
							...
							<div class="row">
								<div class="col-sm-1">
									<s:textfield name="obat.stok" id="stock" onInput="onlyNumber('stock')"
						...
						<div class="form-group">
							...
							<div class="right col-sm-1"><s:submit action="inputObat" cssClass="btn btn-warning" value="Cancel"/></div>
							<div class="right col-sm-1">
								<s:submit action="update" cssClass="btn btn-success" value="Update"/>
							</div>
						</div>
					</div>
				</form>
   	  ...
   	  $("#listTableObat  > tbody tr td").css({"text-align": "center", "vertical-align": "middle"});
			...
			<%-- <div class="panel-body" style="background: transparent; background-color: transparent; ">
				<display:table id="listObt" name="listObat" pagesize="10"
					...
					class="table table-hover" uid="row" style="background: transparent; background-color: transparent; font-family: monospace; font-size: medium; color:#a8a7a7">
