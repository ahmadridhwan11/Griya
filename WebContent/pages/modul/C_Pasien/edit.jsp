	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary" >
				...
				<form namespace="c_pasien" method="post"
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="right col-sm-1"><s:submit action="inputPasienp" cssClass="btn btn-success" value="Cancel"></s:submit></div>
							<div class="right col-sm-1">
								<s:submit action="updatep" cssClass="btn btn-success" value="Update"></s:submit>
							</div>
						</div>
					</div>
				</form>
             ...
             <table id="tbl_sp" class="display" cellspacing="0" width="100%" >
				...
				<tbody>
					...
					<tr>
						...
						<td>
						<s:url id="update" namespace="/pasien" action="initUpdatep.action">
